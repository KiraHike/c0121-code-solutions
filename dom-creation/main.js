...
function renderPokemon(pokemon) {
  ...
  var head2Text = document.createTextNode(pokemon.name);
  head2.appendChild(head2Text);
  pokemonCardText.appendChild(head2);

  var head3 = document.createElement('h3');
  var head3Text = document.createTextNode(pokemon.number);
  head3.appendChild(head3Text);
  pokemonCardText.appendChild(head3);

  var para = document.createElement('p');
  var paraText = document.createTextNode(pokemon.description);
...
function pokemonLoop(array) {
  var pokemonObj = {};
  for (var i = 0; i < array.length; i++) {
    pokemonObj = renderPokemon(array[i]);
    $row.appendChild(pokemonObj);
  }
}
